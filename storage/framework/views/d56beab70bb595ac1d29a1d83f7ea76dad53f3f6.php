<div id="create-operation-modal" class="modal-box">
  ...
  <div class="modal">
    ...
    <form id="create-operation-form">
      ...
      <button type="submit" data-csrf="<?php echo e(csrf_token()); ?>"  id="create-operation-button">Uložiť</button>

    </form>
  </div>

</div><?php /**PATH C:\Users\teodo\personalaccount\src\resources\views/finances/modals/create_operation.blade.php ENDPATH**/ ?>