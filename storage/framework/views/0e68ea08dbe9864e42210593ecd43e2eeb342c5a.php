<div id="create-account-modal" class="modal-box">
  ...
  <div class="modal">
    ...
    <form id="create-account-form">
      ...
      <button type="submit" data-csrf="<?php echo e(csrf_token()); ?>"  id="create-account-button">Uložiť</button>
    </form>
  </div>

</div><?php /**PATH C:\Users\teodo\personalaccount\src\resources\views/finances/modals/create_account.blade.php ENDPATH**/ ?>