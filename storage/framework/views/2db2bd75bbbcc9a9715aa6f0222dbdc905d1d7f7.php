<div id="edit-operation-modal" class="modal-box">
  ...
  <div class="modal">
    ...
    <form id="edit-operation-form">
      ...
      <button type="submit" data-csrf="<?php echo e(csrf_token()); ?>"  id="edit-operation-button">Uložiť</button>

    </form>
  </div>

</div><?php /**PATH C:\Users\teodo\personalaccount\src\resources\views/finances/modals/edit_operation.blade.php ENDPATH**/ ?>