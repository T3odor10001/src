<div id="edit-account-modal" class="modal-box">
  ...
  <div class="modal">
    ...
    <form id="edit-account-form">
        ...
        <button type="submit" data-csrf="<?php echo e(csrf_token()); ?>"  id="edit-account-button">Uložiť</button>
    </form>

  </div>

</div><?php /**PATH C:\Users\teodo\personalaccount\src\resources\views/finances/modals/edit_account.blade.php ENDPATH**/ ?>