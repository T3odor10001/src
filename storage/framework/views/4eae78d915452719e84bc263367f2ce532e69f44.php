...
<?php endif; ?>
  ...
  <div class="modal">
    ...
    <form id="change-pass-form">
      ...
      <button type="submit" data-csrf="<?php echo e(csrf_token()); ?>" id="change-pass-button">Uložiť</button>
    </form>
  </div>

</div><?php /**PATH C:\Users\teodo\personalaccount\src\resources\views/user_account_management/modals/change_password.blade.php ENDPATH**/ ?>