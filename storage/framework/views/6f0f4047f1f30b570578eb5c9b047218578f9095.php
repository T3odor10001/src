                ...
                <form method="POST" action="" id="login-form">
                    ...
                    <div class="input-box">
                        <?php if($errors->has('email')): ?>
                            <div class="field">
                                <input type="text" name="email" id="login-email" value="<?php echo e(old('email')); ?>" style="border-color: red;">
                        ...
                        <?php else: ?>
                            <div class="field">
                                <input type="text" name="email" id="login-email" value="<?php echo e(old('email')); ?>">
                                <label for="login-email">E-mailová adresa</label>
                            </div>
                        <?php endif; ?>
                    </div>
                    ...
                    <a href=<?php echo e(route('forgot-password')); ?>>Zabudli ste heslo?</a>

                </form>
            </div>
        </div>
    </body>
</html><?php /**PATH C:\Users\teodo\personalaccount\src\resources\views/auth/login.blade.php ENDPATH**/ ?>