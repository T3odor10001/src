<div id="add-report-modal" class="modal-box">
  ...
  <div class="modal">
    ...
    <form id="create-report-form">
      ...
      <button data-csrf="<?php echo e(csrf_token()); ?>" type="submit" class="create" id="create-report-button">Uložiť</button>
    </form>
...
<div id="add-excel-modal" class="modal-box">
    ...
    <div class="modal">
        ...
        <form id="create-excel-form">
            ...
            <button data-csrf="<?php echo e(csrf_token()); ?>" type="submit" class="create" id="create-excel-button">Uložiť</button>
        </form>

    </div>

</div>
<?php /**PATH C:\Users\teodo\personalaccount\src\resources\views/finances/modals/add_report.blade.php ENDPATH**/ ?>